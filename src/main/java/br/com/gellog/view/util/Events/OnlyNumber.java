...
public class OnlyNumber implements DocumentListener {

	public OnlyNumber(final JFormattedTextField jFormattedTextField) {
		super();
			...
			public void insertUpdate(DocumentEvent e) {
				...
				Runnable format = new Runnable() {
					...
					public void run() {
						...
						if (!StringUtils.isNumeric(jFormattedTextField.getText())) {

...
public class TabEntregas extends CreateTabStructureAndContent{
	private Icon icon;
	public void tabEntregas(JXTabbedPane tabbedPane) {

		CreateTabStructureAndContent createTabStructureAndContent = new CreateTabStructureAndContent();
		createTabStructureAndContent.tabStructureAndContent(tabbedPane, 5);

...
public class TabelaController {
	...
	static public void updateTabelaPadrao(boolean tabelaPadrao, BigDecimal bh10kg, BigDecimal bhExcedente, BigDecimal rmbh10Kg,
			BigDecimal rmbhExcedente, BigDecimal interior10kg, BigDecimal interiorExcedente, BigDecimal confinsTaxa,
			BigDecimal kmFiorino, BigDecimal kmVanHR, BigDecimal taxaFiorino1h, BigDecimal taxaVan1h,
			BigDecimal taxaFiorino2h, BigDecimal taxaVan2h, BigDecimal taxaFiorino4h, BigDecimal taxaVan4h,
			BigDecimal taxaFiorino6h, BigDecimal taxaVan6h, BigDecimal taxaFiorino8h, BigDecimal taxaVan8h) {
		...
		if(tabelaPadrao) {
		new SimpleQueries().updateObject(tabelaFrete,1);
		} else {
	...
	static public void preencheTabelaPadrao(ContentTabela contentTabela) {
		tabelaFrete = new TabelaFreteDAO().lastResult();

...
public class MotoristaController {
	...
	static public void updateMotorista(Motorista motorista, String nome, String cpf, String email, String telefone,
			String telefone2, boolean ativo) {
		...
		new MotoristaDAO().updateMotorista(motorista);
	}
